            ...
            {visible.map((inv) => (
              ...
              >
                <div
                  ...
                  style={{
                    background: `${inv.projectColor}18`,
                    border: `1px solid ${inv.projectColor}30`,
                  }}
                >
                  <Layers
                    className="w-5 h-5"
                    style={{ color: inv.projectColor }}
                  />
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div
                      ...
                      style={{
                        background: `${inv.inviterColor}30`,
                        border: `1px solid ${inv.inviterColor}40`,
                        color: inv.inviterColor,
                      }}
                    >
