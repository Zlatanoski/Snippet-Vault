        ...
        <header className="flex items-center gap-2 px-4 py-3.5 border-b border-gray-200 dark:border-neutral-800 flex-shrink-0">
          ...
          {editMode ? (
            <div className="flex items-center gap-1.5 flex-1 min-w-0">
              ...
              <button
                onClick={confirmEdit}
                className="w-6 h-6 rounded flex items-center justify-center text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-950/30 transition-colors"
              >
                <Check className="w-3.5 h-3.5" />
              </button>
              <button
                onClick={() => setEditMode(false)}
                className="w-6 h-6 rounded flex items-center justify-center text-gray-400 hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors"
              >
