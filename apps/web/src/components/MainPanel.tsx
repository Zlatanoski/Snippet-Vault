                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        className={[
                            ...
                            "bg-indigo-500",
                            "shadow-[0_1px_3px_rgba(99,102,241,0.35),0_0_0_1px_rgba(99,102,241,0.4)]",
                            "transition-all duration-150",
                            "hover:bg-indigo-400 hover:shadow-[0_2px_8px_rgba(99,102,241,0.45),0_0_0_1px_rgba(99,102,241,0.5)]",
                            "active:scale-95 active:bg-indigo-600 active:shadow-none",
            ...
            <div className="relative flex-1 overflow-y-auto">
                {snippets.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full gap-3 px-6 py-16 text-center">
                        ...
                        <button
                            ...
                            className={[
                                ...
                                "shadow-[0_1px_3px_rgba(99,102,241,0.35)]",
                                "transition-all duration-150 hover:bg-indigo-400 active:scale-95",
                                "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/70 focus-visible:ring-offset-2",
                            ].join(" ")}
                        >
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                    ...
                    <>
                        ...
                        {/* Gradient fade — masks the dead space below the list */}
