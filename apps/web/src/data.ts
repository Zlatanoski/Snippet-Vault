...
export const INVITATIONS: Invitation[] = [
  {
    ...
    role: 'Editor',
    sent: '2h ago',
    description: 'Frontend component library and design system',
  },
  {
    id: '2',
    ...
    role: 'Viewer',
    sent: '1d ago',
    description: 'Machine learning scripts and notebooks',
  },
  {
    id: '3',
    project: 'Infra as Code',
    projectColor: '#34d399',
    inviter: 'Mia Hoffmann',
    inviterInitials: 'MH',
    inviterColor: '#34d399',
    role: 'Editor',
    sent: '3d ago',
    description: 'Terraform and cloud provisioning scripts',
  },
];
